...
if uploaded_file is not None:
    ...
    def user_input_features():
        ...
        country_code=st.sidebar.selectbox("Country_code", ('other', 'USA', 'AUS', 'IND', 'FRA', 'ISR', 'GBR', 'DEU','CAN', 'ESP'))
...
b=(pd.DataFrame(df['country_code'].value_counts()[9:].reset_index())['index'].to_list())
